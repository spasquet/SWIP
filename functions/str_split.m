function terms = str_split(s, delimiter)
...
%       ts = str_split('I am using MATLAB');
%       ts <- {'I', 'am', 'using', 'MATLAB'}
%
%       % split operands delimited by '+'
%       ts = str_split('1+2+3+4', '+');
%       ts <- {'1', '2', '3', '4'}
%
