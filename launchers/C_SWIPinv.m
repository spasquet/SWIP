...
verbose    = 0;          % Display info during inversion (=1) or not (=0)
...
%%% Plot settings
plotinvres = 1;          % Plot inversion results (=1) or not (=0) (!! time consuming !!)
plotparam  = 0;          % Plot inversion parameters (=1) or not (=0) (!! time consuming !!)
...
%%% Calculated dispersion and models display settings (used if plotinvres=1)
