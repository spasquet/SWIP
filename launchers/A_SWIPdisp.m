...
nWmin       = 31;         % Min. window size (nb of traces)
nWmax       = 31;         % Max. window size (nb of traces)
...
mappicklog  = 0;          % Log colorscale for dispersion (=1) or linear (=0)
...
plotpckdisp = 0;          % Save stacked dispersion images with picked curves (=1) or not (=0)
...
plot2dobs   = 0;          % Plot picked dispersion on 2D pseudo-section (=1) or not (=0)
...
cb_disp     = 1;          % Plot colorbar (=1) or not (=0)
